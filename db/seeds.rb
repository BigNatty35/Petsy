...
Product.create(user_id: user3.id, img_url:"https://s3-us-west-1.amazonaws.com/productpics35/badger.jpg", description: "For a devoted, patient animal that’s sure to act affectionately towards the kids, the Badger is your go-to pet. The Badger has a sturdy build that is perfect for kids who like to roughhouse.", title: "Badger", price: 58.88, category_id: cat2.id)
