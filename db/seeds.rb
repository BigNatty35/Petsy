...
Product.create(user_id: user2.id, img_url:"https://s3-us-west-1.amazonaws.com/productpics35/Bacon-toothpaste.jpg", description: "Brushing your teeth with a strip of fried bacon is tricky. If it's too crisp it will break apart as you brush and if it's too limp you won't be able to remove any of the plaque. So when it's time to brush your teeth, leave the bacon strips
